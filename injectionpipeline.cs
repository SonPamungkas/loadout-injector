...
namespace LoadoutInjector
{
    internal static class InjectionPipeline
    {
        ...
        private static ConditionalWeakTable<HardpointSet, HsCacheInfo> _hsCache = new ConditionalWeakTable<HardpointSet, HsCacheInfo>();
        private static ConditionalWeakTable<Aircraft, string> _acNameCache = new ConditionalWeakTable<Aircraft, string>();
        public static void ClearCache()
        {
            _hsCache = new ConditionalWeakTable<HardpointSet, HsCacheInfo>();
            _acNameCache = new ConditionalWeakTable<Aircraft, string>();
        }
